  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <SectionLabel number="7">Profile Completeness</SectionLabel>
        <WireframeBox style={{ padding: isMobile ? 12 : 16 }}>
          <div style={{
            ...
            <div style={{
              ...
              color: completePct >= 80 ? "#16a34a" : "#f59e0b",
            }}>
              {completePct}%
            </div>
          </div>
          ...
          {/* Progress bar */}
          <div style={{ display: "flex", height: 8, borderRadius: 6, overflow: "hidden", marginBottom: 14, background: "#f1f5f9" }}>
            <div style={{
              width: `${completePct}%`, background: completePct >= 80 ? "#16a34a" : "#f59e0b",
          ...
          <div style={{
            ...
            {completionItems.map(({ label, done }) => (
              <div key={label} style={{
                ...
                fontSize: 11, color: done ? "#334155" : "#94a3b8",
                padding: "3px 0",
              }}>
                <span style={{
                  width: 16, height: 16, borderRadius: 4, flexShrink: 0,
                  background: done ? "#dcfce7" : "#f1f5f9",
                  border: done ? "1px solid #86efac" : "1px solid #cbd5e1",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: 9,
                }}>
                  {done ? "✓" : ""}
        ...
        {/* ── 8. PROFILE ACTIONS ── */}
        <SectionLabel number="8">Profile Actions</SectionLabel>
        <WireframeBox style={{ padding: isMobile ? 12 : 16 }}>
          <div style={{ fontSize: 10, fontWeight: 700, color: "#94a3b8", textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 10 }}>
          ...
          <div style={{
            ...
            <div style={{
              flex: 1, padding: "10px 20px",
              background: "#f8fafc", border: "1.5px solid #cbd5e1", borderRadius: 8,
          ...
          <div style={{ marginTop: 14, borderTop: "1px solid #f1f5f9", paddingTop: 12 }}>
            ...
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
              <div style={{
                padding: "6px 14px", background: "#fff7ed", border: "1px solid #fed7aa",
                borderRadius: 6, fontSize: 11, fontWeight: 600, color: "#c2410c",
              }}>
                ⏸ Suspend Profile
              </div>
              <div style={{
                padding: "6px 14px", background: "#fef2f2", border: "1px solid #fecaca",
                borderRadius: 6, fontSize: 11, fontWeight: 600, color: "#b91c1c",
              }}>
                🗑 Remove Profile
              </div>
              <div style={{
                padding: "6px 14px", background: "#f8fafc", border: "1.5px solid #cbd5e1",
